# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 01:31:14 2024
...
import gym.spaces
import numpy as np
from tqdm import tqdm  # 展示進度條

from ES import Control , sepCEM 
...
if __name__ == "__main__":
    ...
    while total_steps < args.max_steps:
        ...
        steplist.append(total_steps) #step score 匯入excel
        scorelist.append(f_mu)
        col1 = "step"
        col2 = "score"
        data = pd.DataFrame({col1:steplist,col2:scorelist})
        data.to_excel('step&score.xlsx', sheet_name='sheet1', index=False)
